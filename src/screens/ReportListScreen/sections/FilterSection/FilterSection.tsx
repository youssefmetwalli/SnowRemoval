...
interface FilterScttionProps{
  filter?: ReportFilter;
};

export const FilterSection = ({filter}:FilterScttionProps): JSX.Element => {
  const filters = [
    {
      label: "日付: 2025/02/02",
      id: "date",
  ...
  return (
    <section className="w-full z-40 items-start gap-2 pt-3 pb-[13px] px-5 bg-white overflow-x-auto border-b border-slate-200 flex translate-y-[-1rem] animate-fade-in opacity-0">
